        ...
        <div class="modal-content">
            ...
            <form id="productForm">
                <div class="form-group">
                    <label class="form-label" for="productId">ID del producto</label>
                    <input type="text" class="form-input" id="productId" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" id="productDescription" required>
                </div>
                <div class="form-group">
                    <label class="form-label" for="productQuantity">Cantidad</label>
                    <input type="number" class="form-input" id="productQuantity" required min="0">
                </div>
                <div class="form-group">
